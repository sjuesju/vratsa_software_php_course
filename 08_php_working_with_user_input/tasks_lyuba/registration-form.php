...
<body>
	...
	<form action="info_registration.php" method="post">
		...
		<p>First name: <input type="text" placeholder="Your First name here" name="first_name"></p>

		<p>Last name: <input type="text" placeholder="Your Last name here"name="last_name"></p>
